...
```
A continuacion tenemos que tratar tambien con las variables categóricas `key`, `mode` , `time_signature`, `is_exlicit`
...
for (mode_value in modes) {
  column_name <- paste0("time_signature_", mode_value)
