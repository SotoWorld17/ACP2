...
spotify2 = spotify
spotify2$popularity <- cut(spotif2y$popularity, breaks = intervalos, labels = c("nada popular", "poco popular", "algo popular", "hit"), include.lowest = TRUE, right = FALSE)
...
rpartFit2 <- train(popularity ~ ., data = training, 
                 method = "rpart", 
...
```{r}
predicciones <- predict(rpartFit2, newdata = testing)
